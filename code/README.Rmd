...
ggplot(mysummary)+ geom_jitter(aes(x=replies, y=topics), shape=21, fill="blue", alpha=0.3) +  geom_text(aes(x=replies, y=topics, label=ids), vjust=-0.4, size=4, color="blue", data=subset(mysummary, topics>5 | replies>30))+xlab("回贴数")+ylab("发贴数")
```
